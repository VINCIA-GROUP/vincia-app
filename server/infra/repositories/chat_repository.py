...
class ChatRepository(Repository):
    ...
    def get_by_history_question_id(self, history_question_id, user_id):
        ...
        for message_tuple in messages_tuple:            
            message_id, message_history_of_question_id, message_role, message_content, message_create_date, sequence = message_tuple
            messages.append(ChatMessages(message_id, message_history_of_question_id, message_role, message_content, message_create_date, sequence))
        messages_sorted = sorted(messages, key = lambda obj: obj.sequence)
        cursor.close()
